...
import jee3060.biway.consumer.service.ReaderConsumer;
...
public class PubSubConfiguration {
    ...
    @Bean
    public MessageListenerAdapter messageListenerAdapter (ReaderConsumer readerConsumer) {
        return new MessageListenerAdapter(readerConsumer, "receive");
    }
    ...
    public SimpleMessageListenerContainer container (ConnectionFactory connectionFactory, MessageListenerAdapter messageListenerAdapter) {
        ...
        container.setQueueNames(readerqueue);
